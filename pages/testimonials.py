...
def layout():
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown('#### Bill Gates'),
            dcc.Markdown('Small Company CEO')
        ], width=2),
        dbc.Col([
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown('#### Alexandra Ocazio Cortez'),
            dcc.Markdown('Silver League Player')
        ], width=2),
        dbc.Col([
    ...
    dbc.Row([
        dbc.Col([
            dcc.Markdown('#### Pope Francis'),
            dcc.Markdown('Local Clergyman')
        ], width=2),
        dbc.Col([
